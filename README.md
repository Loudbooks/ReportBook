...
4. Enter your username, this should be something that would be recognisable from the platform this log was requested from, such as your Discord username.
